...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "purchseorder/test/integration/FirstJourney",
    "purchseorder/test/integration/PurchaseOrder_ERP1ListJourney",
    "purchseorder/test/integration/PurchaseOrder_ERP1ObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
